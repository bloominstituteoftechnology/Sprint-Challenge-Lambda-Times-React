...
const ContainerLogin = styled.span `
cursor: pointer;
`;
...
const TopBar = () => {
  return (
    <Topbar>
      <Container>
        <ContainerLeft>
          <ContainerLeftSpan>TOPICS</ContainerLeftSpan> <ContainerCenterSpan>SEARCH</ContainerCenterSpan>
        </ContainerLeft>
        <ContainerCenter>
        ...
        <ContainerRight>
          <ContainerLogin>LOG IN</ContainerLogin>
        </ContainerRight>
      </Container>
    </Topbar>
  )
