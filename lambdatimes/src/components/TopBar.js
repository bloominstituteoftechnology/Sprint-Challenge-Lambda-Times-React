...
import { TopBarDiv, TopBarDivContainer, ContainerLeftDiv, ContainerCenterDiv, ContainerRightDiv, Spans} from '../CSS/Styles';
  ...
  return (
    <TopBarDiv>
      <TopBarDivContainer>
        ...
        <ContainerLeftDiv>
          <Spans left>TOPICS</Spans><Spans left>SEARCH</Spans>
        </ContainerLeftDiv>
