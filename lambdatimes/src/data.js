...
/*Yes I saw that ^ but I wanted to avoid using toLowerCase() when I can just change five values in here so their capitalization actually matches the rest of the data*/
