...
export const tabData = ['all', 'javascript', 'technology', 'node', 'React.js', 'bootstrap', 'less'];
...
export const cardData = [
  ...
  {
    headline: "Less (which stands for Leaner Style Sheets) is a backwards-compatible language extension for CSS.",
    tab: "less",
    img: "./assets/tree.jpg",
