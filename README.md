...
1.  [x] What are PropTypes used for?
2.  [x] What is a lifecycle event in React?
3.  [x] What is a Higher Order Component?
4.  [x] What are three different ways to style components in React?
